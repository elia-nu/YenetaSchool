...
<body>
    <p>
        Thank you for choosing Yeneta. We're excited to help you get started with our services!
    </p>

    <p>
        To proceed with your payment, please use the following secure link powered by Stripe. This ensures that your transaction is handled safely and efficiently:
        <a href="{{ $sublink }}">{{ $sublink }}</a>
    </p>

    <p>
        Please complete your payment at your earliest convenience. If you have any questions or need further assistance, feel free to contact us at:
        <br>
    
    <p>
        Thank you for your prompt attention to this matter, and we look forward to serving you.
    </p>
